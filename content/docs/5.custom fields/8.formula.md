...
![Formula 1](/docs/customField/formula/Formula_1.png "Formula 1")
...
![Formula 2](/docs/customField/formula/Formula_2.png "Formula 2")
...
2. **Currency**: Use this option to show values in money format. It's great for tracking budgets, revenue, costs, and other financial data. The currency will be formatted according to local standards and supports various global currencies, with [support for numerous global currencies](/docs/custom-fields/currency).
...
![Formula 3](/docs/customField/formula/Formula_3.png "Formula 3")


Users can view the underlying formula logic by hovering over the field.

![Formula 4](/docs/customField/formula/Formula_4.png "Formula 4")
