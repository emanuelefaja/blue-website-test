...
Lookup custom fields allow you to import data from records in other projects, creating one-way visibility. While [Reference custom fields](/docs/custom-fields/reference) establish connections across projects, Lookups use those connections to surface selected data.
...
![Duration](/docs/customField/lookup/Lookup.png "Lookup")
