...
- **A New Record is Created**: Triggers when a new record is added to the project. Useful for initiating follow-up actions or notifications related to new tasks or entries. This also triggers when there is a [new form submission](/docs/projects/forms).
