...
![Blue Make.com Modules Overview](/docs/integration/make/blue_make_modules_overview.png "Overview of available Blue modules in Make.com")
...
![Create a Record Module](/docs/integration/make/create_a_record.png "Create a Record module configuration")

### Execute a GraphQL Query
Run authorized GraphQL operations for advanced data manipulation.

![Execute GraphQL Query Module](/docs/integration/make/execute_a_graphql_query.png "Execute GraphQL Query module configuration")

### Get a Record
Retrieve a record by its ID with all associated data.

![Get a Record Module](/docs/integration/make/get_a_record.png "Get a Record module configuration")

### Invite a User to a Project
Automatically send project invitations to team members.

![Invite User Module](/docs/integration/make/invite_user_to_a_project.png "Invite User to Project module configuration")

### List All Projects
Fetch all your Blue projects with their details.

![List Projects Module](/docs/integration/make/list_all_projects.png "List All Projects module configuration")

### List Custom Fields
Retrieve field metadata for your Blue projects.

![List Custom Fields Module](/docs/integration/make/list_custom_fields.png "List Custom Fields module configuration")

### List Lists of a Project
Access lists/pipelines within your Blue projects.

![List Lists Module](/docs/integration/make/list_lists_of_a_project.png "List Lists of a Project module configuration")

### List Tags Within Projects
Get tag details and their usage across projects.

![List Tags Module](/docs/integration/make/list_tags_within_projects.png "List Tags Within Projects module configuration")

### Search Records of a Project
Filter and find records based on various criteria.

![Search Records Module](/docs/integration/make/search_records_of_a_project.png "Search Records of a Project module configuration")

### Watch Events
Trigger on record creation, update, or deletion.

![Watch Events Module](/docs/integration/make/watch_events.png "Watch Events module configuration")
...
- [Blue API documentation](/api-docs)
