...
![Database 1](/docs/views/database/Database_1.png "Database 1")

## Grouping

Drag column headers to group records by specific properties.

![Database 2](/docs/views/database/Database_2.png "Database 2")

Once you have dragged a column to the header, you will see that your record database will be grouped:

![Database 3](/docs/views/database/Database_3.png "Database 3")

You can also multi-group using multiple columns:

![Database 4](/docs/views/database/Database_4.gif "Database 4")
...
![Database 5](/docs/views/database/Database_5.gif "Database 5")
...
![Database 6](/docs/views/database/Database_6.png "Database 6")
...
- **Group by Assignees**: Group all records by this column, [as discussed earlier in this guide.](/docs/views/database#grouping)

## Show/hide columns

You can easily decide which columns to hide and show when you are viewing the database:

![Database 7](/docs/views/database/Database_7.gif "Database 7")
