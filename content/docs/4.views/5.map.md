...
![Map 1](/docs/views/map/Map_1.png "Map 1")
...
- **Location Tracking**: The Map leverages the [Location/Map custom field](/docs/custom-fields/location-map) to pull in latitude and longitude data associated with records.

- **Visual Identification**: Map pins are color-coded based on the record's primary tag, enabling intuitive recognition.

![Map 2](/docs/views/map/Map_2.png "Map 2")
...
![Map 3](/docs/views/map/Map_3.png "Map 3")

- **Navigation Controls**: Zoom, pan, and snap to your current location.

- **Persistent Filters**: All [filters](/docs/views/filters) applied in other views are maintained on the Map.

![Map 4](/docs/views/map/Map_4.png "Map 4")

## Map in Dark Mode

Works seamlessly with system-level dark mode settings.

![Map 5](/docs/views/map/Map_5.png "Map 5")
