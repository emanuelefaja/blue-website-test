...
![Pie Chart 1](/docs/dashboard/pieChart/PieChart_1.png "Pie Chart 1")

### Create Values or Multiple Values.

You can create multiple slices per chart that will build up your circle. Each slice must pull data from other projects' custom fields to make sense. If you're selecting data from [custom field "Currency"](/docs/custom-fields/currency) the rest of the slices for this should be pulling out from the same data. This allows you to compare the same data across projects in one pie chart.
...
![Pie Chart 2](/docs/dashboard/pieChart/PieChart_2.png "Pie Chart 2")
...
![Pie Chart 3](/docs/dashboard/pieChart/PieChart_3.png "Pie Chart 3")
...
![Pie Chart 4](/docs/dashboard/pieChart/PieChart_4.png "Pie Chart 4")
...
![Pie Chart 5](/docs/dashboard/pieChart/PieChart_5.png "Pie Chart 5")
