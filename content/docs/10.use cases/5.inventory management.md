...
![Inventory Management 1](/docs/useCases/inventoryMangement/1.png "Inventory Management 1")

**Custom Field Requirements**

- [Number](/docs/custom-fields/number): To enter the amount of the product that is currently available
- [Reference](/docs/custom-fields/reference) **&** [Lookup](/docs/custom-fields/lookup): To reference stock-out projects if there are multiple projects
- [Single Line Text](/docs/custom-fields/single-select): To enter the product detail, such as item ID
- [Date](/docs/custom-fields/date): Last update/last check in of the product.
- [Formula](/docs/custom-fields/formula): To calculate the amount of product left in stock.

![Inventory Management 2](/docs/useCases/inventoryMangement/2.png "Inventory Management 2")
...
![Inventory Management 3](/docs/useCases/inventoryMangement/3.png "Inventory Management 3")
...
![Inventory Management 4](/docs/useCases/inventoryMangement/4.png "Inventory Management 4")
