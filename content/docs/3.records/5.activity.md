...
Each entry in the activity log captures the specifics of what was changed, who made the change, and when it occurred. This level of detail extends to all aspects of a record, including changes made to custom fields. Every action is meticulously logged, whether it's an update to a [custom field value](/docs/custom-fields/introduction), a status change, or a modification in the [record's assignment](/docs/records/assignees).
