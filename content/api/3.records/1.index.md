...
To create a record with a title, list, and custom fields, you can use the following mutation. Note that you will have to use the [list custom fields](/api/custom-fields/list-custom-fields) query to get the custom field IDs first that you want to add to the record.
