...
The project ID and company ID are required because custom fields are specific to projects. See the [Authentication documentation](/api-docs/start-guide/authentication) for more details on obtaining these values.
