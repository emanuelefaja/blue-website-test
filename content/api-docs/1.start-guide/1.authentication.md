...
![API 2](/docs/integration/api/API_2.png "API 2")

In the API tab, click on the button "Generate a Token":

![API 3](/docs/integration/api/API_3.png "API 3")
...
![API 4](/docs/integration/api/API_4.png "API 4")
...
![API 5](/docs/integration/api/API_5.png "API 5")
