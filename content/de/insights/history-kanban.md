---
title: Die Geschichte der Kanban Boards
category: "Best Practices"
description: Erfahren Sie die Geschichte der Kanban Boards und wie sie sich von Fabrikböden zu flexiblen digitalen Werkzeugen entwickelt haben.
date: 2024-07-23
---
Bei Blue lieben wir [Kanban Boards](/platform/features/kanban-board). 
...
1. **[Listen (oder Spalten)](https://documentation.blue.cc/records/lists)**: Diese repräsentieren die verschiedenen Phasen in Ihrem Arbeitsablauf. Zum Beispiel könnte ein einfaches Kanban Board Listen mit den Bezeichnungen "Zu erledigen", "In Bearbeitung" und "Erledigt" haben.
2. **[Karten](/platform/features/records)**: Diese repräsentieren einzelne Aufgaben oder Arbeitseinheiten. Jede Karte enthält typischerweise Informationen über die Aufgabe, wie ihre Beschreibung, wer dafür verantwortlich ist und ihr Fälligkeitsdatum.
...
Trotz seiner weit verbreiteten Annahme ist Kanban nicht ohne seine Missverständnisse. Einige glauben fälschlicherweise, es sei schwer einzurichten oder nicht mächtig genug für *"ernsthafte Arbeit"*, die immer lange schriftliche Pläne und [Gantt Charts](/platform/features/timeline-gantt-charts) erfordert. In Wirklichkeit ist Kanbans Einfachheit *eine* seiner größten Stärken und macht es an verschiedene Maßstäbe und Komplexitäten der Arbeit anpassbar.
...
Die Geschichte von Kanban beginnt in den geschäftigen Fabriken des Japan nach dem Zweiten Weltkrieg, speziell bei der Toyota Motor Corporation. In den späten 1940er Jahren wurde einem jungen Wirtschaftsingenieur namens [Taiichi Ohno](https://en.wikipedia.org/wiki/Taiichi_Ohno) die Aufgabe übertragen, Toyotas Fertigungseffizienz zu verbessern. 

![](/insights/taiichi-ohno.jpg)

Ohno identifizierte sieben Quellen der Verschwendung in der Produktion, die jetzt als entscheidend in der [schlanken Fertigung](https://en.wikipedia.org/wiki/Lean_manufacturing) anerkannt sind:

1. Verzögerung, Warten oder Zeit in einer Warteschlange ohne Mehrwertzufügung
2. Mehr produzieren als Sie benötigen
3. Überverarbeitung oder Durchführung von nicht-mehrwertschöpfenden Aktivitäten
4. Transport
5. Unnötige Bewegung oder Motion
6. Inventar
7. Defekte im Produkt
...
1. Sie sind Kosten. Reduzieren Sie zuerst Verschwendung.
2. Sagen Sie zuerst "Ich kann das schaffen." Und versuchen Sie es vor allem anderen.
3. Der Arbeitsplatz ist ein Lehrer. Sie können Antworten nur am Arbeitsplatz finden.
4. Tun Sie alles sofort. Etwas sofort zu beginnen ist der einzige Weg zu gewinnen.
5. Sobald Sie etwas beginnen, beharren Sie darauf. Geben Sie nicht auf, bis Sie es beenden.
6. Erklären Sie schwierige Dinge auf leicht verständliche Weise. Wiederholen Sie Dinge, die leicht zu verstehen sind.
7. Verschwendung ist versteckt. Verstecken Sie sie nicht. Machen Sie Probleme sichtbar.
8. Wertlose Bewegungen sind gleichbedeutend mit der Verkürzung des eigenen Lebens.
9. Verbessern Sie das Verbesserte für weitere Verbesserung.
10. Weisheit wird jedem gleichermaßen gegeben. Der Punkt ist, ob man sie ausüben kann.
...
Andersons Experiment war ein Erfolg. Das Team sah dramatische [Verbesserungen in Produktivität und Moral](/insights/great-teamwork). Dies markierte die Geburt dessen, was als "Kanban für Wissensarbeit" oder "Software-Kanban" bekannt werden sollte.
...
Ein bedeutender Meilenstein in der Verbreitung von Kanban in der Softwareentwicklung und darüber hinaus war der Start von [Trello](/insights/trello) im Jahr 2011. Trello, eine [webbasierte Projektmanagement-Plattform](/solutions/use-case/project-management), popularisierte das Konzept der [digitalen Kanban Boards](/platform/features/kanban-board) für ein breites Publikum.
...
Der Erfolg von Trello löste eine Welle ähnlicher Tools aus, wie [Blue](/), und bald wurden Kanban-Board-Funktionen zu einem Standardangebot in vielen [Projektmanagement-Software-Lösungen](/solutions/use-case/project-management):
...
Als Kanban sich weiter in der Softwarewelt entwickelte, begann es, Projektmanagement-Praktiken in verschiedenen Branchen zu beeinflussen. [Sogar Nicht-Projektmanager begannen, Projektmanager zu werden!](/insights/project-management-basics-guide)
...
Bei [Blue](/bauen wir aktiv die Zukunft der Kanban Boards auf, und deshalb ist es so wichtig, ihre Geschichte zu verstehen. Während wir an der Erfüllung unserer Mission arbeiten, die [beste Projektmanagement-Software der Welt](/solutions/use-case/project-management) zu entwickeln, sehen wir einige Trends für die Zukunft kommen:
...
Das war's! Wir hoffen, Sie haben es genossen, etwas über die Geschichte der Kanban Boards zu lernen. Wenn Sie aktiv nach der Implementierung einer Kanban-Board-Software in Ihrem Team suchen, [können Sie sich gerne für eine kostenlose Testversion von Blue anmelden.](https://app.blue.cc) 
