...
Lists offer bulk actions like tagging all records, assigning records, marking complete/incomplete, or moving records between lists. This enables managing groups of records efficiently. [See our dedicated page on lists for more information](/docs/records/lists)


## Filters

Filters allow focusing on subsets of records based on criteria like assignee, tag, due date, etc. Filters apply only to visible record cards, not the entire lists. [See our dedicated page on filters for more information](/docs/views/filters)
