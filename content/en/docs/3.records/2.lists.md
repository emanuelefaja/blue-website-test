...
Lists have two main use cases:

1. Categorization of records
...
However, note that there is a limit of 50 lists per project, so if you expect to need more than fifty categories, you may want to use [tags](/docs/records/tags) or [single-select](/docs/custom-fields/single-select) or [multiple-select](/docs/custom-fields/multiple-select) custom fields.
