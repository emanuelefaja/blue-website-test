...
1. **Blocking —** The record blocks other records from starting or completing until it is finished. Other records depend on this one being done first.
2. **Blocked By —** The record is blocked by another record that must be completed first before this one can start or finish. This record depends on another one being done before it can proceed.
